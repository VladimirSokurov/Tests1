...
def secretary_program_start():
    ...
    while True:
        ...
        if user_command == 'p':
            user_doc_number = set_input('Введите номер документа - ')
            ...
            new_doc_number = set_input('Введите номер документа - ')
            new_doc_type = set_input('Введите тип документа - ')
            new_doc_owner_name = set_input('Введите имя владельца документа- ')
            new_doc_shelf_number = set_input('Введите номер полки для хранения - ')
            new_doc_shelf_number_ = add_new_doc(new_doc_number, new_doc_type, new_doc_owner_name, new_doc_shelf_number)
            print('\nНа полку "{}" добавлен новый документ:'.format(new_doc_shelf_number_))
        elif user_command == 'd':
            doc_number = set_input('Введите номер документа - ')
            ...
            shelf_number = set_input('Введите номер новой полки - ')
